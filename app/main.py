...
def cinema_visit(customers_list: list, hall_number_visit: int, cleaner: str, movie_arg: str) -> None:
...
# movie = "Madagascar"
#
# cinema_visit(customers_list=customers, hall_number_visit=hall_number, cleaner=cleaner_name, movie_arg=movie)
